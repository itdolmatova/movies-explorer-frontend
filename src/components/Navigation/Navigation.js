        ...
        <div className="navigation">
            ...
            <div className="navigation__burger">
                ...
                <div className="navigation__menu">
                    <div>
                    <Link to="" className="navigation__menu_link">Главная</Link>
                    <Link to="movies" className="navigation__menu_link">Фильмы</Link>
                    <Link to="saved" className="navigation__menu_link">Сохраненные фильмы</Link>
                    </div>
                    <button className="navigation__burger_close-button" src={closeButtonPath} />
                </div>
            </div>
        </div>
    );
