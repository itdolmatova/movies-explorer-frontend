        ...
        <section className="aboutme">
            ...
            <div className="aboutme__container">
                <div className="aboutme__info" >
                    ...
                    <p className="aboutme__text">Я родилась и живу в Краснодаре, закончил социально-гуманитарный факультет КубГТУ по специальности "Документационное обеспечение управления". Проработала в крупном российском операторе связи 9 лет, в т.ч.на должности бизнес-аналитика. Затем ушла в декрет, во время которого прохожу обучение в Яндекс.Практикуме по специальности "Веб-разработчик".</p>
